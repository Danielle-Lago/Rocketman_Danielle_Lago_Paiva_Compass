describe("About Objects", function () {
  ...
  describe("Properties", function () {
    ...
    it("should confirm that properties are case sensitive", function () {
      ...
      expect(megalomaniac.henchWoman).toBe(indefinido);
    });
  });
  ...
  it("should use prototype to add to all objects", function () {
      ...
      expect(simpleCircle.colour).toBe(indefinido);
      expect(colouredCircle.colour).toBe("vermelho")

      Circle.prototype.describe = function () {
        return "This circle has a radius of: " + this.radius;
      };

      expect(simpleCircle.describe()).toBe("Este círculo tem um raio de: 10");
      expect(colouredCircle.describe()).toBe("Este círculo tem um raio de: 5");
  });
});
